...
export class World {
    ...
    createWorld(worldName: string, player: Player, otherPlayers: Array<Player>, enemies: Array<Phaser.GameObjects.Sprite>): void {
        ...
        this.scene.physics.add.collider(player, this.scene.enemyBullets, (player, enemyBullets) => this.scene.enemyBulletsTouchingPlayerHandler(player, enemyBullets));
        this.scene.physics.add.collider(this.scene.spaceShips, this.scene.enemyBullets, (spaceship, enemyBullets) => this.scene.enemyBulletsTouchingSpaceshipHandler(spaceship, enemyBullets));
